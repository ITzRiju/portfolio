...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Facebook',
      href: 'https://facebook.com/photostudio',
      icon: (
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/photostudio',
      icon: (
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/photostudio',
      icon: (
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">info@photostudio.com</span>
                </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-gray-300">
              <span>© {currentYear} PhotoStudio. Made with</span>
